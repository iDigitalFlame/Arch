...
setup_defaults() {
    ...
    /usr/bin/printf 'true\nPrivateUsers            = true\nProtectSystem           = strict\nReadWrit' >> "${SETUP_DIRECTORY}/etc/systemd/system/reflector.service"
    /usr/bin/printf 'ePaths          = /var/cache/pacman\nPrivateDevices          = true\nNoNewPrivil' >> "${SETUP_DIRECTORY}/etc/systemd/system/reflector.service"
    /usr/bin/printf 'eges         = true\nLockPersonality         = true\nRestrictRealtime        = t' >> "${SETUP_DIRECTORY}/etc/systemd/system/reflector.service"
    /usr/bin/printf 'rue\nRestrictSUIDSGID        = true\nProtectKernelLogs       = true\nRestrictNam' >> "${SETUP_DIRECTORY}/etc/systemd/system/reflector.service"
    /usr/bin/printf 'espaces      = true\nProtectControlGroups    = true\nProtectKernelModules    = t' >> "${SETUP_DIRECTORY}/etc/systemd/system/reflector.service"
